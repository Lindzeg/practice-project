...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\Office3\Herd\practiceProject\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Office3\\Herd\\practiceProject\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','vacancies.index',
'vacancies.create','vacancies.store','vacancies.show','vacancies.edit','vacancies.update',
'vacancies.destroy','jobs.index','jobs.create','jobs.store','jobs.show',
'jobs.edit','jobs.update','jobs.destroy','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.forms.contact-form','components.forms.create-jobpost-form','components.forms.create-vacancypost-form',
'components.forms.edit-jobpost-form','components.forms.edit-vacancypost-form','components.forms.login-form','components.forms.register-form','components.header',
'components.layout','components.main','components.nav','components.nav-link','components.section',
'contact','home','jobs.create','jobs.edit','jobs.index',
'jobs.show','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'vacancies.create','vacancies.edit','vacancies.index','vacancies.show','vendor.pagination.bootstrap-4',
...
'vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
